...
#define	FA_READ				0x01	/*指定读访问对象。可以从文件中读取数据。与FA_WRITE结合可以进行读写访问。*/
...
extern int _Fread(void *rbuf, UINT rlen, FIL*rfile);
extern int _Fwrite(void *rbuf,UINT rlen,FIL*rfile);
extern int _Access(const char *filn, int dd);
